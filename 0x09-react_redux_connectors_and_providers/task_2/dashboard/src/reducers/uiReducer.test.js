...
// Define initial state for testing purposes
const initState = {
...
describe("test uiReducer function", () => {
  ...
  it("(uiReducer function) updates isUserLoggedIn to false when action LOGIN_FAILURE is passed", () => {
  ...
  it("(uiReducer function) updates isUserLoggedIn to false and sets user to null when action LOGOUT is passed", () => {
  ...
  it("(uiReducer function) updates isUserLoggedIn to true and sets user with provided email and password when action LOGIN is passed", () => {
